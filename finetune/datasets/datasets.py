...
from .kinetics import VideoClsDataset, VideoMAE, VideoClsDatasetFrame, VideoClsDatasetSegment
...
def build_dataset(is_train, test_mode, args):
    ...
    # me: new added
        ...
        dataset = VideoClsDatasetFrame(
            ...
            new_width=320, # me: actually no use
            args=args,
            file_ext='jpg' # me: new added for MAFW dataset
        )
        nb_classes = 11

    elif args.data_set == 'CELEBV-TEXT':
        mode = None
        anno_path = None
        if is_train is True:
            mode = 'train'
